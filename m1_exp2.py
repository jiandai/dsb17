...
ver 60170404.1 by jian: switch to the next small sample
ver 60170404.2 by jian: fork from exp1, test multi gpu training, compare two recipes: one has more GPU mem footprint
...
h5exists = False
#h5exists = True
h5file='naive-3d-cnn-1.5mm-exp-2.h5'
...
# recipe from https://medium.com/@kuza55/transparent-multi-gpu-training-on-tensorflow-with-keras-8b0016fd9012
...
nn.fit(train_features, train_labels, batch_size=2*1, nb_epoch=N_EPOCH,verbose=1)
#nn.fit(train_features, train_labels, batch_size=2, validation_split=0.1, nb_epoch=N_EPOCH,verbose=1)
