...
if batch_number in range(1,3):
	...
	feature_file = 'test_features-v6-b'+str(batch_number-0)+'.npy'
	...
	feature_file = 'stage2_features-v6-b'+str(batch_number-2)+'.npy'
	...
	feature_file = 'training_features-v6-b'+str(batch_number-7)+'.npy'
...
#h5file='unet-v4-903972.hdf5' # => v5 output for the 5th
h5file='unet-v4-911979.hdf5' # => v6 output for the 6th
